...
//uint8_t  g_noiseBufferArray[NOISE_ARRAY_LEN];
//uint8_t  g_noiseBufferIndex;
...
static void setup(void)
{
  ...
  g_noiseBuffer = ZERO;
	//for ( int i = 0; i<NOISE_ARRAY_LEN ; i++ )
	//{
	//	g_noiseBufferArray[i] = 0xFF;
	//}
  ...
  void T32_INT1_IRQHandler(void)
  {
    ...
    if ( g_counterMicSampler )
    ...
    else
      {
        ...
        //g_noiseBufferIndex++;
        //g_noiseBufferArray[g_noiseBufferIndex&3] = getSampleMicrophone();

    	//uint8_t ave_sound = 0;
    	//for ( int i = 0; i<NOISE_ARRAY_LEN ; i++ )
    	//{
	//ave_sound &= g_noiseBufferArray[i];
    	//}
    	//ave_sound = ave_sound >> 5;
